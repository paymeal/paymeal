...
This mechanism has been integrated into Bitcore-Node-paymeal which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/paymeal/insight-api-paymeal#web-socket-api](https://github.com/paymeal/insight-api-paymeal#web-socket-api)
* API: [https://github.com/paymeal/insight-api-paymeal#instantsend-transactions](https://github.com/paymeal/insight-api-paymeal#instantsend-transactions)
...
By default, the paymeal Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the paymeal Core daemon:
