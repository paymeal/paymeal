...
Only requiring some minor changes is paymeal.cpp.
...
Changes to paymeal.cpp
----------------------
paymeal.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
