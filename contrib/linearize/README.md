# Linearize
Construct a linear, no-fork, best version of the Paymeal blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install paymeal_hash

https://github.com/paymeal/paymeal_hash
...
JSON-RPC server. Running `paymeald` or `paymeal-qt -server` will be sufficient.
...
* `input`: paymeald blocks/ directory containing blkNNNNN.dat
