...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid paymeal address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid paymeal address" in e.error['message'])
