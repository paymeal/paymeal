...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "paymealNetwork") type = paymealNetwork;
    if(strType == "paymealNetworkVariable") type = paymealNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == paymealNetwork) s = "paymealNetwork";
    if(type == paymealNetworkVariable) s = "paymealNetworkVariable";
