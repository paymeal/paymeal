 ...
 *
 *   // network
 *   CpaymealNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.paymeal.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CpaymealNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CpaymealNetwork(UniValue objIn)
    {
...
// // can be under: paymealNetwork
// //   -- signature requirements : Key1(User)
// class CpaymealNetworkVariable : public CGovernanceObject
// {
// private:
