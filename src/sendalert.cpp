...
2. run paymeald with -printalert or -sendalert like this:
   /path/to/paymeald -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.paymeal.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/paymeal Core:0.12.0.58/"));
