    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  paymeal-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the paymeal in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 paymeal, 0.1 paymeal, 1 paymeal and 10 paymeal -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://paymeal.atlassian.net/wiki/display/DOC/PrivateSend\">https://paymeal.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
