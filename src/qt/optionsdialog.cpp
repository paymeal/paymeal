    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("paymeal-light"), QVariant("light"));
  //  ui->theme->addItem(QString("paymeal-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("paymeal-blue"), QVariant("drkblue"));
  //   ui->theme->addItem(QString("paymeal-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("paymeal-traditional"), QVariant("trad"));
