...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in paymeal.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("paymeal.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Paymeal features */
    { "paymeal",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "paymeal",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "paymeal",               "gobject",                &gobject,                true,  {} },
    { "paymeal",               "voteraw",                &voteraw,                true,  {} },
