...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print paymeal address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "paymeal",               "masternode",             &masternode,             true,  {} },
    { "paymeal",               "masternodelist",         &masternodelist,         true,  {} },
    { "paymeal",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "paymeal",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "paymeal",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "paymeal",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
